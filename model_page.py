...
# Load data
data = pd.read_csv(r"C:\Users\MAarif\Documents\Guvi\Task\Singapore_Flat_ResalePrices_Predicting-main\dataset\Pricedata.csv")
...
def model_data():
   with open(r"C:\Users\MAarif\Documents\Guvi\Task\Singapore_Flat_ResalePrices_Predicting-main\resale_rfr.pkl",'rb') as files:
